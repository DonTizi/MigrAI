...
const ConversationPage =() => {
    ...
    return (
        <div>
            <Heading
            title="Immigration Explainer"
            description="The most advanced model in terms of Immigration explanation, ask him any questions you are unfamiliar with and he will explain everything to you as simply as possible. "
            icon={FileQuestion }
