...
const Codepage =() => {
    ...
    return (
        <div>
            <Heading
            title="Immigration Simulation"
            description="Immigration Simulation powered by an AI NLP (Natural Language Processing) model."
            icon={Calculator}
                                ...
                                <FormItem className="col-span-12 lg:col-span-10">
                                  <FormControl className="m-0 p-0">
                                    <Input
                                      ...
                                      disabled={isLoading} 
                                      placeholder="Start the conversation by saying hello, can we begin? to start the simulation of MigrAI's immigration processes." 
                                      {...field}
                                    />
                                    </FormControl>
                                </FormItem>
